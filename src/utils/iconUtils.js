import { 
  ...
  GraduationCap, Building, Mail, Phone, Globe, Trash2, FileText
} from 'lucide-react';
...
const icons = {
  ...
  user: User, settings: Settings, filebadge: FileBadge, graduationcap: GraduationCap, building: Building, mail: Mail, phone: Phone, globe: Globe, trash2: Trash2, filetext: FileText
};
